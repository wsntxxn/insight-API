...
var InsightAPI = function(options) {
  ...
  this.coinShort = options.coinShort || 'BTC';
...
InsightAPI.prototype.setupRoutes = function(app) {//传入的app是new express()的结果
...
//一个关键的问题：不知道什么时候InsightAPI.subscribe被调用了
